...
const papers = [
  {
      ...
      "topic": "Algorithmic Reasoning & Procedural Tasks",
  ...
  },
  {
      ...
      "topic": "Diffusion & Iterative Text Generation",
  ...
  },
  {
      ...
      "topic": "Optimization & Inductive Bias",
  ...
  },
  {
      ...
      "topic": "Transformers & Language Modeling",
  ...
  },
  {
      ...
      "topic": "In-Context Learning & Skill Transfer",
  ...
  },
  {
      ...
      "topic": "Visual & Multi-Modal Models",
  ...
  },
  {
      ...
      "topic": "Attention Mechanisms & Positional Encoding",
  ...
  },
  {
      ...
      "topic": "Robustness, Compression & Calibration",
  ...
  },
  {
      ...
      "topic": "Sparse & Interpretable Representations",
  ...
  },
  {
      ...
      "topic": "Trust, Fairness & Explanations",
...
[
  {
    "cluster_id": 0,
    "name": "Robustness, Compression & Calibration",
    "keywords": [
      "adversarial robustness",
      "compression",
      "sharpness",
    ...
    "summary": "Focuses on model robustness and compression techniques. Includes work on conformal prediction, sharpness-aware learning, spectral constraints, and uncertainty quantification in compressed or adversarial settings."
  },
  {
    "cluster_id": 1,
    "name": "Sparse & Interpretable Representations",
    "keywords": [
      "sparse autoencoders",
      "dictionary learning",
      "interpretability",
    ...
    "summary": "Centers on interpretability via sparsity, evaluating and improving the extraction of human-aligned concepts from neural networks through methods like dictionary learning and matching pursuit."
  },
  {
    "cluster_id": 2,
    "name": "Optimization & Inductive Bias",
    "keywords": [
      "optimization",
      "deep learning",
      "reinforcement learning",
    ...
    "summary": "Covers theoretical and empirical studies of optimization methods and inductive biases in deep learning. Topics include flatness vs. sharpness, reweighting strategies, and convergence dynamics."
  },
  {
    "cluster_id": 3,
    ...
    "summary": "Focused on transformers and LLMs, especially for tasks like length generalization, next-token prediction, and performance scaling in autoregressive or masked setups."
  },
  {
    "cluster_id": 4,
    "name": "Visual & Multi-Modal Models",
    "keywords": [
      "visual prompting",
      "multi-modal",
      "fusion",
    ...
    "summary": "Emphasizes fusion between modalities like vision and text, exploring strategies like visual prompting, domain-aware fusion, and adaptation under data or resource constraints."
  },
  {
    "cluster_id": 5,
    "name": "Trust, Fairness & Explanations",
    "keywords": [
      "trustworthiness",
      "fairness",
      "bias",
    ...
    "summary": "Investigates ethical and safety aspects of models\u2014steering, representation alignment, social bias, explanation faithfulness, and the impact of fine-tuning or interventions."
  },
  {
    "cluster_id": 6,
    "name": "Diffusion & Iterative Text Generation",
    "keywords": [
      "prm",
      "error correction",
      "inference-time guidance",
    ...
    "summary": "Focused on diffusion-based language models and iterative refinement strategies, especially using reward models to guide and remask generations for better inference-time performance."
  },
  {
    "cluster_id": 7,
    "name": "Attention Mechanisms & Positional Encoding",
    "keywords": [
      "attention",
      "position",
      "masking",
    ...
    "summary": "Investigates positional and structural biases in attention mechanisms, including rotary encodings, causal masking effects, and the emergence of early-position dominance."
  },
  {
    "cluster_id": 8,
    "name": "In-Context Learning & Skill Transfer",
    "keywords": [
      "prompting",
      "in-context learning",
      "instructions",
    ...
    "summary": "Studies how LMs adapt to tasks via prompting, with a focus on math problem-solving and dynamically adjusting skill examples to avoid cognitive overload in small models."
  },
  {
    "cluster_id": 9,
    "name": "Algorithmic Reasoning & Procedural Tasks",
    "keywords": [
      "algorithmic reasoning",
      "procedural",
      "flip-flops",
    ...
    "summary": "Targets synthetic and procedural tasks like algorithm simulation, planning, and modular reasoning. Includes work on procedural pretraining and theoretical analysis of generalization."
  }
];

const topicSummaries = {
'Robustness, Compression & Calibration':'Focuses on model robustness and compression techniques. Includes work on conformal prediction, sharpness-aware learning, spectral constraints, and uncertainty quantification in compressed or adversarial settings.',
'Sparse & Interpretable Representations':'Centers on interpretability via sparsity, evaluating and improving the extraction of human-aligned concepts from neural networks through methods like dictionary learning and matching pursuit.',
'Optimization & Inductive Bias':'Covers theoretical and empirical studies of optimization methods and inductive biases in deep learning. Topics include flatness vs. sharpness, reweighting strategies, and convergence dynamics.',
'Transformers & Language Modeling':'Focused on transformers and LLMs, especially for tasks like length generalization, next-token prediction, and performance scaling in autoregressive or masked setups.',
'Visual & Multi-Modal Models':'Emphasizes fusion between modalities like vision and text, exploring strategies like visual prompting, domain-aware fusion, and adaptation under data or resource constraints.',
'Trust, Fairness & Explanations':'Investigates ethical and safety aspects of models—steering, representation alignment, social bias, explanation faithfulness, and the impact of fine-tuning or interventions.',
'Diffusion & Iterative Text Generation':'Focused on diffusion-based language models and iterative refinement strategies, especially using reward models to guide and remask generations for better inference-time performance.',
'Attention Mechanisms & Positional Encoding':'Investigates positional and structural biases in attention mechanisms, including rotary encodings, causal masking effects, and the emergence of early-position dominance.',
'In-Context Learning & Skill Transfer':'Studies how LMs adapt to tasks via prompting, with a focus on math problem-solving and dynamically adjusting skill examples to avoid cognitive overload in small models.',
'Algorithmic Reasoning & Procedural Tasks':'Targets synthetic and procedural tasks like algorithm simulation, planning, and modular reasoning. Includes work on procedural pretraining and theoretical analysis of generalization.',
};
